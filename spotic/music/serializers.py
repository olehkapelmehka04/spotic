...
from .models import CustomUser, Song, SongEstimation, Playlist, PlaylistSong
...
class SongSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Song
        fields = ['id', 'title', 'singer', 'singer_id', 'duration', 'genre', 'release_date']
...
class PlaylistSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Playlist
        fields = ['playlist_name', 'owner', 'owner_id', 'visibility']
