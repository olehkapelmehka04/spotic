...
class Song(models.Model):
    ...
    singer = models.ForeignKey(CustomUser, on_delete=models.CASCADE, limit_choices_to={'role', 'singer'},
                               related_name='songs')
...
class SongEstimation(models.Model):
    ...
    listener = models.ForeignKey(CustomUser, on_delete=models.CASCADE, limit_choices_to={'role': 'listener'}, related_name='estimations')
...
class Playlist(models.Model):
    ...
    owner = models.ForeignKey(CustomUser, on_delete=models.CASCADE, limit_choices_to={'role': 'listener'}, related_name='playlists')
    visibility = models.CharField(max_length=12, choices=VisibilityChoices, default=VisibilityChoices.PRIVATE)
